  ...
  categories: [
    {
      title: 'عام',
      questions: [
        { label: 'ما هي خبرتك في تطوير الويب؟', content: 'لدي خبرة أكثر من 3 سنوات في تطوير واجهات المستخدم باستخدام Vue.js و Nuxt.js، بالإضافة إلى خبرة في MEVN Stack الكامل.' },
        { label: 'ما هي التقنيات التي تستخدمها؟', content: 'أستخدم Vue.js, Nuxt.js, Tailwind CSS, MongoDB, Express.js, Node.js وغيرها من التقنيات الحديثة.' },
