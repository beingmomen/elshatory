<template>
  <p
    id="typed"
    class="font-bold text-5xl sm:text-6xl bg-custom-gradient bg-clip-text text-gradient mt-6 min-h-[136px] sm:min-h-[100px] text-center xl:text-start py-5"
  >
    <span ref="typedText" class="cursor" />
  </p>
</template>
