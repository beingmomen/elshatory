<template>
  <section class="py-16">
    <UContainer>
      <div>
        <p class="text-xs font-bold uppercase tracking-widest text-neutral-500 mb-3">نظرة عامة بصرية</p>
        <h2 class="text-3xl sm:text-4xl font-bold mb-3 sdlc-display">٦ مراحل · الأدوار في لمحة</h2>
      ...
      <Transition name="modal-fade">
        <div v-if="activeRole" class="modal-backdrop" @click.self="closeModal">
          <div class="modal-card" dir="rtl">
            ...
            <p class="modal-role-en">{{ roleDetails[activeRole]?.en }}</p>
