<template>
  <section class="py-20">
    <UContainer>
      <div>
        <p class="text-xs font-bold uppercase tracking-widest text-neutral-500 mb-3">حلقات التغذية الراجعة</p>
        <h2 class="text-3xl sm:text-4xl font-bold mb-3 sdlc-display">نظام تدفق القرارات</h2>
