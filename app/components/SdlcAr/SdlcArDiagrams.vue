<template>
  <section id="diagrams" class="py-20">
    <UContainer>
      <div>
        <p class="text-xs font-bold uppercase tracking-widest text-neutral-500 mb-3">المخرجات البصرية</p>
        <h2 class="text-3xl sm:text-4xl font-bold mb-3 sdlc-display">أنواع مخططات UML</h2>
