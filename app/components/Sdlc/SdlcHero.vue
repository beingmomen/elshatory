      ...
      <div class="grid lg:grid-cols-2 gap-16 items-center py-16">
        ...
        <div>
          <p class="eyebrow sdlc-display">
            Architect Playbook · <span class="ooad-badge">OOA&amp;D</span>
          </p>
          <h1 class="hero-h1 mb-6">
            <span class="sdlc-word-wrap"><span class="sdlc-word-inner sdlc-display">Software</span></span><br>
            <span class="sdlc-word-wrap"><span class="sdlc-word-inner sdlc-display">Development</span></span><br>
            <span class="sdlc-word-wrap sdlc-display gradient-line"><span class="sdlc-word-inner text-gradient sdlc-display">Life Cycle</span></span>
          </h1>
          ...
          <div class="flex gap-4 flex-wrap">
            <a href="#analysis" class="btn-primary">Explore Phases →</a>
          </div>
        </div>
...
.phase-nav-card {
  ...
  border-left: 3px solid var(--card-color, rgba(255,255,255,0.2));
  text-decoration: none;
  color: inherit;
  transition: all 0.2s;
}
