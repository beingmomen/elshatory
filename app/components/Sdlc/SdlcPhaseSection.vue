  ...
  <section :id="phase.id" class="py-20 relative" @mousemove="onMouseMove">
    ...
    <UContainer>
      ...
      >
        ...
        <div>
          <div class="text-4xl font-black tracking-tight sdlc-display" :class="`text-${phase.color}-400`">
            {{ phase.title }}
          </div>
      ...
      <div class="grid md:grid-cols-3 gap-5 mb-6">
        ...
        >
          <div class="badge badge-a mb-4">⚡ Layer A · Quick Scan</div>
          ...
          <div class="output-box" :style="`--pc: var(--color-${phase.color}-500, #06b6d4)`">
            <div class="output-label" :class="`text-${phase.color}-400`">Key Output</div>
        ...
        <div
          ...
          :style="`--pc: var(--color-${phase.color}-500, #06b6d4)`"
        >
          <div class="badge badge-b mb-4">📋 Layer B · Structured</div>
        ...
        <div
          class="layer-c-card"
        >
          <div class="badge badge-c mb-4">🧠 Layer C · Architect Notes</div>
