<template>
  <section id="diagrams" class="py-20">
    <UContainer>
      <div>
        <p class="text-xs font-bold uppercase tracking-widest text-neutral-500 mb-3">Visual Artifacts</p>
        <h2 class="text-3xl sm:text-4xl font-bold tracking-tight mb-3 sdlc-display">UML Diagram Zones</h2>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        >
          ...
          <h4 class="text-sm font-bold mb-2 sdlc-display text-neutral-100">{{ diagram.name }}</h4>
          <p class="text-xs leading-snug mb-3" style="color: #9ca3af">{{ diagram.desc }}</p>
          <span
