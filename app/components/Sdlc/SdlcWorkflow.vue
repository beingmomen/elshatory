<template>
  <section class="py-20">
    <UContainer>
      <div>
        <p class="text-xs font-bold uppercase tracking-widest text-neutral-500 mb-3"><span class="ooad-badge">OOA&amp;D</span> Process Pipeline</p>
        <h2 class="text-3xl sm:text-4xl font-bold tracking-tight mb-3 sdlc-display">Analysis &amp; Design Workflow</h2>
...
const stages = [
  {
    title: 'Requirements',
    color: '#06b6d4',
    items: ['Vision', 'Functional Requirements', 'Non-Functional Requirements', 'Constraints', 'Assumptions'],
  },
  {
    title: 'Problem Domain',
    color: '#8b5cf6',
    items: ['Define system boundaries', 'Identify core entities', 'Map domain relationships', 'Establish scope limits'],
  },
  {
    title: 'Use Cases',
    color: '#10b981',
    items: ['Mission use-case', 'System use-cases', 'List all Actors', 'Activity diagrams'],
  },
  {
    title: 'Define Architecture',
    color: '#f59e0b',
    items: ['Decompose architecture', 'Define components', 'Map interfaces', 'Select patterns'],
  },
  {
    title: 'Deployment',
    color: '#f97316',
    items: ['Infrastructure setup', 'CI/CD pipeline', 'Environment config', 'Go-live plan'],
  },
]
</script>
