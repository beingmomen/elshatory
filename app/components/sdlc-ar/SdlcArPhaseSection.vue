...
const metaItems = computed(() => [
  { label: 'الأدوار', value: props.phase.meta.roles, icon: 'i-lucide-users' },
  { label: 'السؤال المحوري', value: props.phase.meta.question, icon: 'i-lucide-help-circle' },
  { label: 'محفّز المرحلة التالية', value: props.phase.meta.trigger, icon: 'i-lucide-arrow-left-circle' },
  { label: 'مخاطر التجاوز', value: props.phase.meta.risk, icon: 'i-lucide-alert-triangle' }
])
</script>
