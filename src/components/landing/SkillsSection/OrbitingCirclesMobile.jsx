...
function OrbitingCirclesDemo() {
  return (
    <div className="relative  flex md:hidden h-[400px] w-full flex-col items-center justify-center overflow-hidden">
      ...
      <OrbitingCircles iconSize={30} radius={160} reverse speed={1}>
